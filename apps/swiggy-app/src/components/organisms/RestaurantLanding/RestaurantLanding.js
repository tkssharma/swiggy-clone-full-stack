      ...
      <div className="container">
        <Wrapper>
          <div className="row">
            ...
            <div className="col-9" data-spy="scroll" data-target="#list" data-offset="0">
              ...
              <Section className="row">
                ...
                <div className="row row-cols-3 justify-content-center" id="Exclusive">
                  {exclusive.map((item) => (
                    <HotelCard data={item} key={item._id} />
                  ))}
                </div>
              ...
              <Section className="row">
                <Title>Premium</Title>
                <div className="row row-cols-3 justify-content-center" id="Premium">
                  {premium.map((item) => (
                    <HotelCard data={item} key={item._id} />
                  ))}
                </div>
              ...
              <Section className="row">
                ...
                <div className="row row-cols-3 justify-content-center" id="vegOnly">
                  {veg.map((item) => (
                    <HotelCard data={item} key={item._id} />
                  ))}
                </div>
