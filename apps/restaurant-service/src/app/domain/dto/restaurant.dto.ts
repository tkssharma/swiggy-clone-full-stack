...
export class CreateRestaurantParam {
  ...
  @ApiProperty({
    description: "",
    required: true,
    example: "swiggy serving customers",
  })
  @IsString()
  @MinLength(4)
  public about_us!: string;
  ...
  @ApiProperty({
    ...
    required: false,
    example:
      "https://www.oneindia.com/img/2017/09/coupon-article-sep-15-2-15-1505472816.jpg",
  })
  @IsOptional()
  @IsString()
